...
def research_GC(UniProt_file_path,gb_file_path):
    ...
    _, A_Name_gb_protein_dictionary,_ = tools.get_dictionary_of_protain_from_GB_file(gb_file_path,"nucleotide")
    ...
    for key, val in dictionary_of_transmembrane.items():
        if key in A_Name_gb_protein_dictionary:
            B[key] = A_Name_gb_protein_dictionary[key]
            global_len_B += len(A_Name_gb_protein_dictionary[key])
            GC_count_B += A_Name_gb_protein_dictionary[key].count('G')
            GC_count_B += A_Name_gb_protein_dictionary[key].count('C')
    ...
    for key, val in A_Name_gb_protein_dictionary.items() :
        ...
        global_len_A += len(val)




    res_B = tools.get_GC_and_len_statistic(B,GC_count_B,global_len_B)
    res_A = tools.get_GC_and_len_statistic(A_Name_gb_protein_dictionary,GC_count_A,global_len_A)
    res_A_not_in_B = tools.get_GC_and_len_statistic(A_not_in_B,GC_count_A_not_in_B,global_len_A_not_in_B)
    print("---len for B---")
    ...
    print("---len for A---")
    print("len min = "+str(res_A['len']["min"]))
    print("len max = "+str(res_A['len']["max"]))
    print("len avg = "+str(res_A['len']["avg"]))
    print("len median = "+str(res_A['len']["median"]))
    ...
    print("---gc len for A---")
    print("gc min = "+str(res_A['gc']["min"]))
    print("gc max = "+str(res_A['gc']["max"]))
    print("gc avg = "+str(res_A['gc']["avg"]))
    print("gc median = "+str(res_A['gc']["median"]))
